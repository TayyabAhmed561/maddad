...
export default function KaffarahPage() {
  ...
  const handleDonate = async () => {
    ...
    console.log("Kaffarah donation processed:", {
      type: selectedType,
      amount,
          ...
          <div className="container mx-auto px-4 py-12 md:py-16">
            <div className="max-w-3xl">
              ...
              <h1 className="heading-display text-3xl md:text-4xl text-foreground mb-4">
                Kaffarah — Expiation for Obligations
              </h1>
              
              <p className="text-lg text-muted-foreground text-body max-w-2xl mb-6">
                Kaffarah is a form of compensation required when certain religious obligations are 
                intentionally violated. It provides a path to seek forgiveness through prescribed acts of charity.
              </p>

              {/* Distinction from Fidya */}
              <div className="bg-secondary/50 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    <p className="mt-1">
                      Fidya is paid when someone <em>cannot</em> fast due to illness or old age. 
                      Kaffarah applies when a fast or oath is <em>intentionally</em> broken and requires 
                      a more significant form of compensation.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-card rounded-xl border border-border p-6 md:p-8">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h2 className="font-serif text-xl font-semibold text-foreground">Select Obligation Type</h2>
                </div>
                <p className="text-sm text-muted-foreground mb-6">
                  Choose the type of Kaffarah that applies to your situation.
                </p>
              ...
              <div className="bg-card rounded-xl border border-border p-6 md:p-8">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  All partners are verified and follow Islamic guidelines for Kaffarah distribution.
                </p>
                <div className="flex items-center gap-2 text-xs text-muted-foreground mb-6">
                  <ShieldCheck size={12} className="text-primary" />
                  <span>Guided by scholarly review</span>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Kaffarah requirements can vary based on individual circumstances and scholarly 
                      interpretation. If you're unsure about your obligation or the appropriate amount, 
                      we encourage you to consult with a knowledgeable scholar or imam.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-xl border border-border p-6 sticky top-6">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Kaffarah type</span>
                    <span className="font-medium text-foreground text-right">
                      {selectedOption?.title || "Not selected"}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="border-t border-border pt-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-xl font-serif font-semibold text-primary">
                        ${amount > 0 ? amount.toLocaleString(undefined, { minimumFractionDigits: 2 }) : "0.00"}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <Button
                  ...
                  disabled={!selectedPartner || !selectedType || amount <= 0 || isLoading || isSuccess}
                >
                  {isLoading ? (
                    <>
                ...
                {isSuccess && (
                  <div className="mt-4 space-y-3">
                    <p className="text-sm text-center text-muted-foreground">
                      May Allah accept your Kaffarah. A private receipt has been sent to your email.
                    </p>
                    <p className="text-xs text-center text-muted-foreground italic">
                      Kaffarah fulfilled through verified partners following scholarly guidelines.
                    </p>
