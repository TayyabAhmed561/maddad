...
const globalRealItems: MapItem[] = [
  // Gaza / Palestine - Expanded coverage
  {
    id: "gl-1",
    type: "need",
    ...
    goal: 5000000,
    privacyLevel: "global_ok",
    description: "Critical medical supplies and emergency healthcare services for hospitals across Gaza.",
    countryCode: "PS"
  },
  {
    id: "gl-2",
  ...
  // Additional Palestine entries - Khan Younis
  {
    id: "gl-ps-1",
    type: "need",
    title: "Khan Younis Emergency Shelter",
    orgName: "UNRWA",
    category: "Shelter",
    verifiedStatus: "verified",
    endorsedBy: "United Nations",
  ...
  },
  {
    id: "gl-ps-2",
    type: "appeal",
    title: "Khan Younis Medical Supplies",
    orgName: "Médecins Sans Frontières",
    category: "Medical",
    verifiedStatus: "verified",
    zakatEligible: true,
    locationLabel: "Khan Younis, Palestine",
    ...
    goal: 800000,
    privacyLevel: "global_ok",
    description: "Critical medical supplies and surgical equipment for field hospitals.",
    countryCode: "PS"
  },
  // Rafah
  {
    ...
    goal: 2000000,
    privacyLevel: "global_ok",
    description: "Emergency food distribution and humanitarian supplies at the Rafah crossing area.",
    countryCode: "PS"
  },
  {
    id: "gl-ps-4",
    type: "appeal",
    title: "Rafah Children's Relief",
    ...
    goal: 400000,
    privacyLevel: "global_ok",
    description: "Educational support and psychological care for children affected by the crisis.",
    countryCode: "PS"
  },
  // Deir al-Balah
  {
    id: "gl-ps-5",
    type: "need",
    title: "Deir al-Balah Food Distribution",
    ...
    goal: 1200000,
    privacyLevel: "global_ok",
    description: "Daily meal distribution and food packages for displaced populations.",
    countryCode: "PS"
  },
  {
    id: "gl-ps-6",
    ...
    orgName: "Palestinian Medical Relief Society",
    category: "Medical",
    verifiedStatus: "verified",
    zakatEligible: true,
    locationLabel: "Deir al-Balah, Palestine",
    ...
    goal: 700000,
    privacyLevel: "global_ok",
    description: "Emergency medical care and surgical support for wounded civilians.",
    countryCode: "PS"
  },
  // Gaza City
  {
    id: "gl-ps-7",
    type: "need",
    title: "Gaza City Water & Sanitation",
    orgName: "UNICEF",
    category: "Medical",
    verifiedStatus: "verified",
    endorsedBy: "United Nations",
    ...
    goal: 1800000,
    privacyLevel: "global_ok",
    description: "Clean water access and sanitation infrastructure repair for Gaza City residents.",
    countryCode: "PS"
  },
  {
    id: "gl-ps-8",
    ...
    goal: 2500000,
    privacyLevel: "global_ok",
    description: "Direct Zakat distribution to eligible families verified through local scholars.",
    countryCode: "PS"
  },
  // West Bank cities
  {
    ...
    goal: 200000,
    privacyLevel: "global_ok",
    description: "Food security and community support programs for families in Nablus.",
    countryCode: "PS"
  },
  {
    id: "gl-ps-10",
    ...
    orgName: "Palestinian Red Crescent",
    category: "Medical",
    verifiedStatus: "verified",
    zakatEligible: true,
    ...
    goal: 150000,
    privacyLevel: "global_ok",
    description: "Emergency medical services and ambulance support for Hebron communities.",
    countryCode: "PS"
  },
  {
    id: "gl-ps-11",
    ...
    goal: 120000,
    privacyLevel: "global_ok",
    description: "Educational scholarships and school supplies for students in Ramallah.",
    countryCode: "PS"
  },
  // Syria
  {
