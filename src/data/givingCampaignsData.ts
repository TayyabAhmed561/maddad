...
export const givingCampaigns: Record<string, GivingCampaignData> = {
  ...
  zakat: {
    ...
    checklist: {
      requiredEvidenceTypes: ["org_registration", "org_financial_audit"],
      approvedEvidenceTypes: ["org_registration", "org_financial_audit"],
      completionPercent: 100,
  ...
  qurbani: {
    ...
    checklist: {
      requiredEvidenceTypes: ["org_registration", "milestone_delivery_confirmation"],
      approvedEvidenceTypes: ["org_registration", "milestone_delivery_confirmation"],
      completionPercent: 100,
  ...
  "sadaqah-jariyah": {
    ...
    title: "Sadaqah Jariyah Endowment Program",
    partner: "Multi-Partner Network",
    checklist: {
      requiredEvidenceTypes: ["org_registration", "org_financial_audit", "milestone_progress_photo"],
      approvedEvidenceTypes: ["org_registration", "org_financial_audit", "milestone_progress_photo"],
      completionPercent: 100,
    ...
    milestones: [
      ...
      },
      {
        stage: "funds_allocated",
        date: "2025-10-15",
        summary: "Endowment funds released for project implementation across multiple locations.",
        evidenceIds: ["ev-giving-audit-001"],
      },
      {
        stage: "in_progress",
        date: "2026-01-10",
        summary: "Projects under construction: wells, schools, masjids. Progress documented monthly.",
        evidenceIds: ["ev-giving-impact-photo"],
      },
    ],
    evidenceIds: [...sharedOrgEvidence, "ev-giving-impact-photo", "ev-giving-distribution-001"],
    trackingId: "MDD-SJRY-2026-0001",
  },
